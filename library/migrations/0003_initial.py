...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('library', '0002_remove_book_author_delete_author_delete_book'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='library.gategory')),
            ],
        ),
    ]
